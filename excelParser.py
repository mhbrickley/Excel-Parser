...
while True:
    try:
        #user input
        path = input('Enter the path of the Excel file you wish to parse: ').strip()
    ...
    extension = input('Enter the extension for each newly parsed file: ').strip()
    ...
    #break out of while loop if parsing completed successfully
    break
